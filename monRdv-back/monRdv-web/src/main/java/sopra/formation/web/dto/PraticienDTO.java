...
public class PraticienDTO {
	...
	private List<String> paiement = new ArrayList<String>();
	private boolean carteBancaire;
	private boolean cheque;
	private boolean espece;
	private Integer dureeCreneau;
	private List<String> specialites = new ArrayList<String>();
	...
	public PraticienDTO(Praticien praticien) {
		...
		if (this.carteBancaire) {
			this.paiement.add("carte Bancaire");
		}
		if (this.cheque) {
			this.paiement.add("cheque");
		}
		if (this.espece) {
			this.paiement.add("espece");
		}
	}
